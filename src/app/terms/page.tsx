...
export const metadata: Metadata = createPageMetadata({
  title: "Website Terms",
  description: "Terms governing use of the Universal Packaging Group website and quote information.",
  path: "/terms",
});
    ...
    <>
      <section className="bg-olive px-6 pt-32 pb-20 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <SectionSubheading className="text-offwhite/70">Effective August 3, 2026.</SectionSubheading>
        </div>
      </section>
      <Section variant="cream">
        <div className="mx-auto max-w-3xl space-y-8 text-sm leading-7 text-charcoal/75">
          <div>
            ...
            <p className="mt-3">Website content, images, planning MOQs, lead-time ranges, materials, and finishes are general information, not a binding offer or guarantee. Product suitability and availability depend on confirmed specifications and supplier review.</p>
          </div>
          <div>
